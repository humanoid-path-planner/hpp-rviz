...
class Waypoint: public rviz_common::Tool {
    ...
    private:
        ...
        rclcpp::Subscription<hpp_msgs::msg::HppWaypoint>::SharedPtr waypoint_visibility_sub_;
        int waypoint_count_ = 0;

        void onWaypointVisibilityReceived(const hpp_msgs::msg::HppWaypoint::SharedPtr msg);
